 ...
 *
 * - DragStateProvider: Manages drag/drop state (draggingItem, dragOverColumn)
 * - SelectionStateProvider: Manages card selection state (selectedIds)
 * - ViewModeProvider: Manages view configuration (viewMode, groupBy, activityPanelOpen)
 */
