...
// Custom X icon component - typed to match LucideIcon interface
...
import type { FeedbackItem, KanbanChannel, KanbanPriority, Sentiment } from '../../lib/kanbanTypes';
import type { GroupByField, SwimlaneData, SwimlaneConfig } from './swimlaneTypes';
import { CHANNEL_COLORS, PRIORITY_SWIM_COLORS, SENTIMENT_COLORS } from './swimlaneTypes';
