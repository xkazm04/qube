...
import type { Sentiment, KanbanPriority } from '../../lib/kanbanTypes';
...
// Sentiment colors - light tones for quick identification
...
// Priority colors - light tones for quick identification
export const PRIORITY_COLORS: Record<KanbanPriority, { bg: string; text: string; border: string }> = {
