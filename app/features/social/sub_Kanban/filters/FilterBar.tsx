...
import type { KanbanChannel, KanbanPriority, Sentiment } from '../../lib/kanbanTypes';
import type { FilterState } from './filterTypes';
import { CHANNEL_LABELS, PRIORITY_LABELS, SENTIMENT_LABELS, SLA_LABELS } from './filterTypes';
import { SearchInput } from './SearchInput';
import { FilterDropdown } from './FilterDropdown';
import { FilterChip } from './FilterChip';
import type { SLAStatus } from '../sla/slaTypes';
...
export function FilterBar({
  ...
  return (
    <div className="flex flex-col gap-2 p-3 rounded-lg bg-[var(--color-surface)]/50 border border-[var(--color-border)]">
      {/* Main filter row */}
